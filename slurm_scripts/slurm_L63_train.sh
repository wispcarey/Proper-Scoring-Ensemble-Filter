...
# Input: Env vars DATASET, EPOCHS, N, SIGMA_Y, VERSION, LOSS_TYPE, LOSS_WEIGHTS, USE_PF, LEARNING_RATE, OBS_FN, WEIGHT_DECAY, ADAPTIVE_SIGMA_Y, SUFFIX.
...
echo "Config: DATASET=$DATASET, EPOCHS=$EPOCHS, N=$N, v=$VERSION, PF=$USE_PF, LR=$LEARNING_RATE, obs_fn=$OBS_FN, weight_decay=$WEIGHT_DECAY, adaptive_sigma_y=$ADAPTIVE_SIGMA_Y, SUFFIX='$SUFFIX', LOSS_WEIGHTS=$LOSS_WEIGHTS"
